...
namespace SDRSharp.BladeRF
{
    ...
    {
        BLADERF_RX_X1 = (((0) << 1) | 0x0),
        BLADERF_TX_X1 = (((0) << 1) | 0x1),
        BLADERF_RX_X2 = (((1) << 1) | 0x0),
        BLADERF_TX_X2 = (((1) << 1) | 0x1)
    ...
    class NativeMethods
    {
        ...
        [DllImport("bladeRF", CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern int bladerf_get_sample_rate_range(IntPtr dev, int ch, bladerf_range** range);
        ...
        [DllImport("bladeRF", CallingConvention = CallingConvention.Cdecl)]
        public static extern int bladerf_set_gain_mode(IntPtr dev, bladerf_module module, bladerf_gain_mode mode);
        ...
        [DllImport("bladeRF", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr bladerf_get_board_name(IntPtr dev);
